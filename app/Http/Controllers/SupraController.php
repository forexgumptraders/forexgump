...
class SupraController extends Controller
{
    ...
    public function supraIndex()
    {

        return view('robot.supraIndex');
    }
    ...
    public function supra()
    {
        ...
        $supraRobot = $robots->first(function ($robot) {
            // Busca 'supra' en el nombre del archivo sin importar mayúsculas o minúsculas
            return stripos($robot->name, 'supra') !== false;
        });

        return view('robot.supra', compact('supraRobot'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('robot.supra')->with('status', 'Robot subido correctamente');
