                        ...
                        <div class="bg-white dark-bg-gray-800 overflow-hidden  sm-rounded-lg p-6">
                            <div class="mb-2">
                                <div class="card bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert">
                                    <p class="font-bold text-center">US$129</p>
                        ...
                        <div class="bg-white dark-bg-gray-800 overflow-hidden shadow-xl sm-rounded-lg p-6">
                            <div class="mb-2">
                                <div class="bg-green-100 border-t text-center border-b border-green-500 text-green-700 px-4 py-3" role="alert">
                                    <p class="font-bold text-center">Ya tienes acceso al BOT Aureum</p>
                                    <a href="{{ route('robot.aureum') }}" class="text-lg text-center text-green-700 hover:underline">Ver mas</a>
                                </div>
                            </div>
            ...
            window.paypal
                .Buttons({
                    async createOrder() {
                        ...
                        return axios.post('/trading-ai/aureum/create-paypal-order', {
                            amount: 129
                    ...
                    async onApprove(data, actions) {
                        return axios.post('/trading-ai/aureum/capture-paypal-order', {
                            orderID: data.orderID

                        }).then(function(response) {
                            window.location.href = '/view-bot-aureum';
                        }).catch(function(error) {
                            console.log(error);
                        });
                    },
