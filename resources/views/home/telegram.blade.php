...
<x-app-layout>
  <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div style="background-color: #f8f8f8; padding: 20px; border-radius: 10px; text-align: center;">
      <h3 style="margin-bottom: 10px;">Únete a nuestro grupo de Telegram</h3>
      <p style="margin-bottom: 20px;">Haz clic en el botón de abajo para unirte</p>
      <a href="{{ $telegramGroupInviteLink }}" onclick="getTelegramIdAndRedirect()" style="display: flex; justify-content: center; align-items: center;">
