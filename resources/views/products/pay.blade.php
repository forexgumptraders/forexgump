            ...
            <div class="col-span-7">
                <article class="card">
                    <div class="card-body">
                        ...
                        <p class="text-sm text-gray-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro, voluptas consequatur quas <br> <br> <a class="text-pink-600 font-bold " href="/terminos">Terminos y condiciones</a>.</p>
