...
<section class="home">
    ...
    <div class="u-wrapper">
      <div class="contact-content">
        ...
        <form id="form" action="{{route('contactanos.store')}}" class="form" method="POST">
            @csrf
          ...
          <input name="email" type="text" id="email" placeholder="juan@gmail.com">
        ...
        @if (session('info'))
            <script>
                ...
                swal('{{session('info')}}', 'Te responderemos cuanto antes', 'success');
