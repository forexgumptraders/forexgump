...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Ripped 404 Page Animation</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><link rel='stylesheet' href='https://fonts.googleapis.com/css2?family=Nunito:wght@400;700&amp;display=swap'><link rel="stylesheet" href="./style.css">
...
<main>
	...
	<div>
		<h1>404</h1>
		<p>Ups, al parecer esta página no existe.</p>
		<a class="btn-link" href="/">Ir a ForexGump</a>
	</div>
</main>
<!-- partial -->
