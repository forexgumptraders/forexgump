      ...
      <div class="max-width">
          <div class="row">
            <div class="home-content">
                <div class="text-1">Unite a la comunidad de</div>
                <div class="text-2">Traders</div>
                <div class="text-3">Visita nuestro blog</div>
                <a href="login">Unite ahora</a>
             ...
             <div id="home-contentSliderInicio">
            ...
            <div class="about-content">
                <div class="column left">
                  ...
                  <div class="home-contentSlider">
                     <img src="./img/equipo.png" alt="" class="spin" >
                  </div>

                </div>
                   <div class="column right">
                    <div class="text">Nosotros</div>
                    <p>Forex Gump es una plataforma contribuida por traders que se especializa en el mundo de la bolsa, visita nuestro blog con diferentes tipos de articulos y categorias. <br>
                    Descubri posteos nuevos todos los dias con informacion actualizada y relevante realizados por traders con mas de 10 años de experiencia en los mercados financieros.
                   </p>
                    <a href="#signals">Unite ahora</a>
                </div>
            </div>
        </div>
    </section>
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mx-auto">
        ...
        <p>Visita nuestra seccion de categorias y enterate de las ultimas noticias del mundo de la bolsa.</p><br>
